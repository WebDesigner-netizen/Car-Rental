...
const BASIC_URL = "http://localhost:9000"; // Change to string
...
export class CustomerService {
  ...
  bookACar(bookACarDto: any):Observable<any>{
    return this.http.post(BASIC_URL + "/api/customer/car/book",  bookACarDto, { // Correct URL and pass headers object
